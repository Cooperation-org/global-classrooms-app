...
import { FaUser, FaEnvelope, FaPhone, FaVenusMars, FaBook, FaCalendarAlt, FaLink, FaCamera } from 'react-icons/fa';
  ...
  return (
    <div className="w-full max-w-3xl mx-auto py-10 px-4">
      <div className="bg-white rounded-2xl shadow-lg p-8">
        ...
        <p className="text-green-700 mb-8">Fill out the following details to register a new student. A one-time invitation link will be generated on successful submission.</p>
        <form className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
          ...
          {/* Assigned Class */}
          <div className="col-span-1">
            <label className="block font-semibold mb-1 flex items-center gap-2"><FaBook className="text-green-500" /> Assigned Class</label>
            <select className="w-full bg-green-50 rounded-lg px-4 py-3 outline-none focus:ring-2 focus:ring-green-200">
