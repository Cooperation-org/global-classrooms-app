...
const mockDetails = {
  subtitle:
    "A collaborative project to reduce waste in schools and promote sustainable practices.",
  tags: ["Waste Management", "Sustainability", "Environmental Education"],
  overview:
    "The Eco-Action Initiative is a collaborative project aimed at reducing waste in schools and promoting sustainable practices. Participating schools will work together to implement waste reduction strategies, educate students about environmental issues, and create a positive impact on their communities.",
  goals:
    "Reduce school waste by 50% within one year, educate students about waste reduction, and promote sustainable practices.",
  type: "Cross-School",
  ...
  contribution: {
    offering:
      "Guidance on waste reduction strategies, access to educational resources, and mentorship.",
    expectation:
      "Active participation in project activities, implementation of waste reduction strategies, and sharing of best practices.",
  },
  targets: [
    "Plant 200 trees",
  ...
  rewards: [
    {
      ...
      label: "Most Innovative Solution",
    },
    {
      image: "https://img.icons8.com/color/96/000000/medal2.png",
      label: "Best Community Impact",
    },
  ],
  media: [
    {
      image:
        "https://assets-global.website-files.com/5f6b7b6c6e2c6e2c6e2c6e2c/5f6b7b6c6e2c6e2c6e2c6e2c_waste-sorting.svg",
      label: "Waste Sorting Activity",
    },
    {
      image:
    ...
    },
    {
      ...
      label: "School Garden Project",
    },
  ],
  files: [{ name: "Project Plan.pdf" }],
  discussion: [
    {
      user: "Sarah Miller",
      avatar:
        "https://images.unsplash.com/photo-1503676382389-4809596d5290?w=100",
      message:
        "Excited to start this project with my students! Any tips for the initial data collection phase?",
      time: "2 days ago",
    },
    {
      user: "David Chen",
      ...
      message:
        "We found it helpful to involve students in designing the data collection methods. It increases their engagement and ownership of the project.",
      time: "1 day ago",
    },
  ],
};
...
export default function CollaborationDetailsPage() {
  ...
  const collab =
    mockCollaborations.find((c) => c.id === id) || mockCollaborations[0];

  return (
    <div className="max-w-5xl  px-4 sm:px-6 lg:px-8 py-10">
      {/* Breadcrumbs */}
      <div className="text-sm text-[#4BA186] mb-2">
        Collaborations / <span className="text-gray-900">{collab.title}</span>
      </div>
      ...
      <div className="flex flex-wrap gap-3 mb-6">
        {mockDetails.tags.map((tag) => (
          <span
            key={tag}
            className="px-4 py-2 rounded-full bg-[#E6F4EA] text-[#4BA186] font-medium text-sm"
          >
            {tag}
          </span>
        ))}
      ...
      <Link
        href={`/dashboard/collaborations/${id}/join`}
        className="mb-8 px-6 py-3 bg-black text-white rounded-lg font-medium text-base flex items-center gap-2 hover:bg-[#222B45] transition"
      >
        Join Collaboration
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
        <div>
          <div className="text-[#9CA3AF] font-semibold mb-1">
            Goals & Objectives
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8 items-center">
        <div className="md:col-span-2">
          ...
          <div className="font-bold text-lg text-gray-900">
            {mockDetails.leadSchool.name}
          </div>
          <div className="text-gray-500 mb-2">
            Location: {mockDetails.leadSchool.location}
          </div>
          <button className="mb-4 px-4 py-2 bg-[#E6F4EA] text-[#4BA186] rounded-lg font-medium">
            View School Profile
          </button>
          <div className="flex gap-8">
            <div>
              ...
              <div className="text-gray-900 font-medium">
                {mockDetails.leadSchool.contact}
              </div>
            </div>
            <div>
              <div className="text-gray-500">Role</div>
              <div className="text-gray-900 font-medium">
                {mockDetails.leadSchool.role}
              </div>
            </div>
          </div>
        </div>
        <img
          src={mockDetails.leadSchool.image}
          alt="Lead School"
      ...
      <div className="flex gap-3 mb-8">
        {mockDetails.participatingSchools.map((s, i) => (
          <img
            ...
            src={s.logo}
            alt="School"
            className="w-10 h-10 rounded-full bg-[#E6F4EA]"
          />
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
        <div>
          <div className="text-[#9CA3AF] font-semibold mb-1">
            What Greenwood Academy is Offering
          </div>
          <div className="text-gray-900">
            {mockDetails.contribution.offering}
          </div>
        </div>
        <div>
          <div className="text-[#9CA3AF] font-semibold mb-1">
          ...
          <div className="text-gray-900">
            {mockDetails.contribution.expectation}
          </div>
        </div>
      </div>
      {/* Goals/Targets */}
      ...
      <div className="text-gray-500 mb-8">
        Earn digital badges and certificates upon achieving project milestones
        or demonstrating exceptional contributions. Recognitions include
        &apos;Most Innovative Solution&apos; and &apos;Best Community
        Impact&apos;.
      </div>
      {/* Media & Documents */}
      <h2 className="text-xl font-bold text-gray-900 mb-2">
        ...
        {mockDetails.media.map((m, i) => (
          <div key={i} className="flex flex-col items-center">
            <img
              src={m.image}
              alt={m.label}
              className="w-36 h-24 rounded-xl object-cover mb-1"
            />
      ...
      {mockDetails.files.map((f, i) => (
        <div
          key={i}
          className="flex items-center gap-2 bg-gray-50 rounded-lg px-4 py-2 mb-8 w-fit"
        >
          <svg width="20" height="20" fill="none" viewBox="0 0 20 20">
            <rect x="3" y="3" width="14" height="14" rx="2" fill="#E6F4EA" />
            <path
              d="M7 8h6M7 12h4"
              stroke="#4BA186"
              strokeWidth="2"
        ...
        <div className="flex items-center gap-3 mt-4">
          ...
          <button className="w-10 h-10 flex items-center justify-center rounded-full bg-[#E6F4EA] text-[#4BA186]">
            <svg width="22" height="22" fill="none" viewBox="0 0 22 22">
              <path
                d="M3 11L19 3M3 11L19 19M3 11H15"
                stroke="#4BA186"
                strokeWidth="2"
                strokeLinecap="round"
                strokeLinejoin="round"
