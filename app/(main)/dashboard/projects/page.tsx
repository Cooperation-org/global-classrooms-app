...
const projects = [
  {
    ...
    description:
      "Implement water conservation strategies and water quality monitoring systems in school and surrounding community.",
    tags: ["Water", "SDG 6"],
    status: "Active",
    image:
  ...
  },
  {
    ...
    description:
      "Develop and implement a comprehensive zero waste strategy for schools to reduce landfill waste.",
    tags: ["Waste", "SDG 6"],
    status: "Active",
    image:
  ...
  },
  {
    ...
    description:
      "Map and protect local biodiversity through community science initiatives and habitat restoration.",
      ...
      <div className="p-4 flex-1 flex flex-col">
        ...
        <div className="flex items-center justify-between mt-auto">
          ...
          <Link
            ...
            className="px-3 py-1 text-xs font-medium rounded bg-gray-100 hover:bg-gray-200 transition-colors"
          >
            View Details
          </Link>
        </div>
  ...
  return (
    <div className="p-8">
      ...
      <p className="text-muted-foreground mb-6">
        Explore and join projects aligned with UN Sustainable Development Goals
      </p>
      {/* Tabs */}
