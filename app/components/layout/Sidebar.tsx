...
const Sidebar: React.FC<SidebarProps> = ({ open = false, onClose }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside className={`fixed top-0 left-0 h-screen w-64 bg-white border-r border-gray-100 flex flex-col px-6 py-8 z-30 transition-transform duration-300 ease-in-out ${
